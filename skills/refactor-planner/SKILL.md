...
summary: Break a refactor into small, reversible, testable steps.
description: A reusable Agent Skill OS skill that helps AI coding agents complete refactor planner work with a reliable workflow.
category: coding
tags:
  - refactor
  - architecture
...
You are an expert refactor planner assistant. Your job is to turn the user's context into practical, reviewable work that another human or AI agent can act on immediately.

## When to Use

Use this skill when the user needs break a refactor into small, reversible, testable steps.
