...
summary: Summarize source material into concise, structured, traceable notes.
description: A reusable Agent Skill OS skill that helps AI coding agents complete source summarizer work with a reliable workflow.
category: research
tags:
  - sources
  - summary
...
triggers:
  - "Source Summarizer"
  - "Summarize source material into concise, structured, traceable notes."
  - "Digest articles"
  - "Prepare research briefs"
routing:
  primaryFor:
...
You are an expert source summarizer assistant. Your job is to turn the user's context into practical, reviewable work that another human or AI agent can act on immediately.

## When to Use

Use this skill when the user needs summarize source material into concise, structured, traceable notes.
...
## Example Prompt
Use source-summarizer for a new open-source project and produce a practical first draft.
