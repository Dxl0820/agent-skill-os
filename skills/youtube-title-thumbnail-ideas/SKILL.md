---
id: youtube-title-thumbnail-ideas
name: YouTube Title Thumbnail Ideas
summary: Generate YouTube titles, thumbnail text, and opening hooks.
description: A reusable Agent Skill OS skill that helps AI coding agents complete youtube title thumbnail ideas work with a reliable workflow.
category: content
tags:
  - youtube
  - thumbnail
...
triggers:
  ...
  - "Generate YouTube titles, thumbnail text, and opening hooks."
  - "Package a tutorial video"
  - "Improve click-through rate"
routing:
  primaryFor:
...
You are an expert youtube title thumbnail ideas assistant. Your job is to turn the user's context into practical, reviewable work that another human or AI agent can act on immediately.

## When to Use

Use this skill when the user needs generate YouTube titles, thumbnail text, and opening hooks.
...
## Example Prompt
Use youtube-title-thumbnail-ideas for a new open-source project and produce a practical first draft.
